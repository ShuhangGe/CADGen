...
def main():
    ...
    model_path = '/scratch/sg7484/CMDGen/results/train_1e-5_fulldata_autoregressive_maskedpadding_bert6_depth8_cadonly_VecSet/model/CADGEN_best_train_1.948228359222412_test_1.8950926065444946'
    ...
    for i, data in enumerate(test_loader):
        ...
        #commands_ = gt_vec[:, :, 0]
        z = model.forward_encoder(cad_data,command_ys, paramaters_ys)#front_pic,top_pic,side_pic,
