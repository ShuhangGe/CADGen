...
def get_args():
    ...
    parser = argparse.ArgumentParser(description='valid_network')
    ...
    #test
    parser.add_argument('--test_outputs', type=str, default='../out')
    ...
    parser.add_argument('--num_group', type=int, default=32)#64
    parser.add_argument('--num_heads', type=int, default=4)#6
    parser.add_argument('--trans_dim', type=int, default=128)#384
    '''num_group*num_heads = trans_dim'''
    parser.add_argument('--encoder_dims', type=int, default=128)#384
