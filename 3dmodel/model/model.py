...
class Views2Points(nn.Module):
    ...
    def forward(self,side,front,top,cad_data):
        ...
        #         # print('i: ',i)
        #         # print('0: ',int((cad_data[j,i,0]+1)/2*64))
        #         # print('1: ',int((cad_data[j,i,1]+1)/2*64))
        #         # print('2: ',int((cad_data[j,i,2]+1)/2*64))
        #         data = torch.cat([feature_3d[j,:,int((cad_data[j,i,0]+1)/2*64),int((cad_data[j,i,1]+1)/2*64),int((cad_data[j,i,2]+1)/2*64)].unsqueeze(0)],dim=0)
