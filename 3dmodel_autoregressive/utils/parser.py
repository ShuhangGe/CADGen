...
def get_args():
    ...
    parser.add_argument('--resnet_out', type=int, default=256)#
    ...
    parser.add_argument('--npoints', type=int, default=512)#1728
    ...
    #text encoder
    #parser.add_argument('--args_dim', type=int, default=256)#embedding dimession of test_embeding
    parser.add_argument('--n_args', type=int, default=N_ARGS)# number of paramaters of each command 
    parser.add_argument('--n_commands', type=int, default=len(ALL_COMMANDS))#
    parser.add_argument('--n_layers', type=int, default=4)#model of text encoder
    parser.add_argument('--n_layers_decode', type=int, default=4)
    parser.add_argument('--n_heads', type=int, default=8)#model of text encoder
    parser.add_argument('--dim_feedforward', type=int, default=512)#model of text encoder
    parser.add_argument('--d_model', type=int, default=256)#model of text encoder
    parser.add_argument('--dropout', type=float, default=0.1 )#model of text encoder
    parser.add_argument('--dim_z', type=int, default=256)#model of text encoder out dim of text encoder
    parser.add_argument('--use_group_emb', type=bool, default=True)#model of text encoder
    ...
    parser.add_argument('--max_num_groups', type=int, default=30)#model of text encoder
    parser.add_argument('--max_total_len', type=int, default=MAX_TOTAL_LEN)#model of text encoder
    ...
    #transformer decoder
    parser.add_argument('--d_model_transdecoder', type=int, default=256)
    ...
    #momentum loss
    parser.add_argument('--do_momentum', type=bool, default=True)
    parser.add_argument('--queue_size', type=int, default=16000)
    parser.add_argument('--momentum', type=float, default=0.995)
    parser.add_argument('--momentum_dim', type=int, default=256)
    parser.add_argument('--alpha', type=float, default=0.4)
    
    #deformable_decoder
    parser.add_argument('--d_model_deformable', type=int, default=256)
    parser.add_argument('--nhead_deformabel', type=int, default=8)
    parser.add_argument('--k_deformabel', type=int, default=3)
    parser.add_argument('--scales_deformabel', type=int, default=3)
...
#     parser.add_argument('--d_model', type=int, default=256)#model of text encoder
#     parser.add_argument('--dropout', type=float, default=0.1 )#model of text encoder
#     parser.add_argument('--dim_z', type=int, default=256)#model of text encoder
#     parser.add_argument('--use_group_emb', type=bool, default=True)#model of text encoder
#     parser.add_argument('--max_n_ext', type=int, default=MAX_N_EXT)
#     parser.add_argument('--max_n_loops', type=int, default=MAX_N_LOOPS)
#     parser.add_argument('--max_n_curves', type=int, default=MAX_N_CURVES)
